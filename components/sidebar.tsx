...
import { LayoutDashboard, ListTodo, CheckCircle2, Clock, AlertCircle, CheckSquare, Layers } from "lucide-react"
...
export function Sidebar({
  ...
  return (
    <div className="w-64 bg-muted/40 border-r h-screen flex flex-col">
      ...
      {/* Only show navigation when not in profile view */}
      {!showProfile && (
        <>
          <div className="p-4">
          ...
          {/* Only show filters when not in profile view and board tab is active */}
          {activeTab === "board" && (
